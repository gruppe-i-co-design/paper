...
Knuth goes deeply into the ways in which sorting networks kan be optimized and are created in his masterpiece; _The Art of Computer Programming_ [@knuthsortnetwork1998]. Further the parallelization of the algorithm is e explained in the book _GPU Gems 2_ from Nvidia pe apter , which details optimized sorting on GPUs using sorting networks and parallel comparisions. The parallelization aspect is quite similar between GPUs and FPGAs.
...
ODgxfX0sImhpc3RvcnkiOlsxMTkzNDcyNDM4LDk4Mzk1OTM2N1
19
-->